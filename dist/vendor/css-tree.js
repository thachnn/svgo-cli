(() => {
  var __webpack_modules__ = {
    7791: (module, __unused_webpack_exports, __webpack_require__) => {
      const mdnAtrules = __webpack_require__(4518), mdnProperties = __webpack_require__(3050), mdnSyntaxes = __webpack_require__(9262), patch = __webpack_require__(4900), extendSyntax = /^\s*\|\s*/;
      function patchDictionary(dict, patchDict) {
        const result = {};
        for (const key in dict) result[key] = dict[key].syntax || dict[key];
        for (const key in patchDict) key in dict ? patchDict[key].syntax ? result[key] = extendSyntax.test(patchDict[key].syntax) ? result[key] + " " + patchDict[key].syntax.trim() : patchDict[key].syntax : delete result[key] : patchDict[key].syntax && (result[key] = patchDict[key].syntax.replace(extendSyntax, ""));
        return result;
      }
      function unpackSyntaxes(dict) {
        const result = {};
        for (const key in dict) result[key] = dict[key].syntax;
        return result;
      }
      module.exports = {
        types: patchDictionary(mdnSyntaxes, patch.syntaxes),
        atrules: function(dict, patchDict) {
          const result = {};
          ...
          for (const key in patchDict) hasOwnProperty.call(dict, key) || (result[key] = {
          ...
          for (const atruleName in dict) {
            ...
            if (atrule.descriptors) {
              ...
              for (const descriptor in atrule.descriptors) descriptors[descriptor] = atrule.descriptors[descriptor].syntax;
            }
    ...
    7467: module => {
      ...
      List.createItem = createItem, List.prototype.createItem = createItem, List.prototype.updateCursors = function(prevOld, prevNew, nextOld, nextNew) {
        ...
        releaseCursor(this);
      }, List.prototype.forEachRight = List.prototype.eachRight, List.prototype.reduce = function(fn, initialValue, context) {
        var item;
        void 0 === context && (context = this);
        for (var cursor = allocateCursor(this, null, this.head), acc = initialValue; null !== cursor.next; ) item = cursor.next, 
        cursor.next = item.next, acc = fn.call(context, acc, item.data, item, this);
        return releaseCursor(this), acc;
      }, List.prototype.reduceRight = function(fn, initialValue, context) {
        var item;
        void 0 === context && (context = this);
        for (var cursor = allocateCursor(this, this.tail, null), acc = initialValue; null !== cursor.prev; ) item = cursor.prev, 
        cursor.prev = item.prev, acc = fn.call(context, acc, item.data, item, this);
        return releaseCursor(this), acc;
    ...
    9971: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    542: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      TokenStream.prototype = {
        ...
        getRawLength: function(startToken, mode) {
          ...
          loop: for (;cursor < this.tokenCount && !((balanceEnd = this.balance[cursor]) < startToken); cursor++) switch (mode(this.offsetAndType[cursor] >> 24, this.source, offset)) {
           ...
           default:
            this.balance[balanceEnd] === cursor && (cursor = balanceEnd), offset = 16777215 & this.offsetAndType[cursor];
          }
        ...
        forEachToken(fn) {
          for (var i = 0, offset = this.firstCharOffset; i < this.tokenCount; i++) {
            var start = offset, item = this.offsetAndType[i], end = 16777215 & item;
    ...
    3196: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    7062: (module, __unused_webpack_exports, __webpack_require__) => {
      var createCustomError = __webpack_require__(2451);
    ...
    3515: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    8975: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    7801: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      function matchSyntax(lexer, syntax, value, useCommon) {
        ...
        useCommon && result.match || (result = matchAsTree(tokens, syntax.match, lexer)).match ? buildMatchResult(result.match, null, result.iterations) : buildMatchResult(null, new SyntaxMatchError(result.reason, syntax.syntax, value, result), result.iterations));
      }
      ...
      Lexer.prototype = {
        ...
        addAtrule_: function(name, syntax) {
          syntax && (this.atrules[name] = {
            ...
            descriptors: syntax.descriptors ? Object.keys(syntax.descriptors).reduce(((res, descName) => (res[descName] = this.createDescriptor(syntax.descriptors[descName], "AtruleDescriptor", descName, name), 
            res)), {}) : null
          });
        },
        ...
        addType_: function(name, syntax) {
          syntax && (this.types[name] = this.createDescriptor(syntax, "Type", name), syntax === generic["-ms-legacy-expression"] && (this.valueCommonSyntax = cssWideKeywordsWithExpression));
        },
        ...
        checkAtrulePrelude: function(atruleName, prelude) {
          ...
          return !atrule.prelude && prelude ? new SyntaxError("At-rule `@" + atruleName + "` should not contain a prelude") : atrule.prelude && !prelude ? new SyntaxError("At-rule `@" + atruleName + "` should contain a prelude") : void 0;
        },
        checkAtruleDescriptorName: function(atruleName, descriptorName) {
          let error = this.checkAtruleName(atruleName);
          if (error) return error;
          var atrule = this.getAtrule(atruleName), descriptor = names.keyword(descriptorName);
          return atrule.descriptors ? atrule.descriptors[descriptor.name] || atrule.descriptors[descriptor.basename] ? void 0 : new SyntaxReferenceError("Unknown at-rule descriptor", descriptorName) : new SyntaxError("At-rule `@" + atruleName + "` has no known descriptors");
        },
        checkPropertyName: function(propertyName) {
          return names.property(propertyName).custom ? new Error("Lexer matching doesn't applicable for custom properties") : this.getProperty(propertyName) ? void 0 : new SyntaxReferenceError("Unknown property", propertyName);
        },
        matchAtrulePrelude: function(atruleName, prelude) {
          var error = this.checkAtrulePrelude(atruleName, prelude);
          return error ? buildMatchResult(null, error) : prelude ? matchSyntax(this, this.getAtrule(atruleName).prelude, prelude, !1) : buildMatchResult(null, null);
        },
        ...
        getAtrule: function(atruleName, fallbackBasename = !0) {
        ...
        getAtrulePrelude: function(atruleName, fallbackBasename = !0) {
        ...
        getProperty: function(propertyName, fallbackBasename = !0) {
    ...
    1628: (module, __unused_webpack_exports, __webpack_require__) => {
      const createCustomError = __webpack_require__(2451), generate = __webpack_require__(1381), defaultLoc = {
        offset: 0,
        line: 1,
        column: 1
      };
      ...
      module.exports = {
        ...
        SyntaxMatchError: function(message, syntax, node, matchResult) {
          const error = createCustomError("SyntaxMatchError", message), {css, mismatchOffset, mismatchLength, start, end} = function(matchResult, node) {
    ...
    1524: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    5167: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    4583: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      function isCommaContextStart(token) {
        return null === token || (token.type === TYPE.Comma || token.type === TYPE.Function || token.type === TYPE.LeftParenthesis || token.type === TYPE.LeftSquareBracket || token.type === TYPE.LeftCurlyBracket || function(token) {
          return token.type === TYPE.Delim && "?" !== token.value;
        }(token));
      }
    ...
    4882: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    5007: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    2055: (module, __unused_webpack_exports, __webpack_require__) => {
      var OffsetToLocation = __webpack_require__(9971), SyntaxError = __webpack_require__(542), TokenStream = __webpack_require__(2879), List = __webpack_require__(7467), tokenize = __webpack_require__(7093), constants = __webpack_require__(3786), {findWhiteSpaceStart, cmpStr} = __webpack_require__(5951), sequence = __webpack_require__(8987), noop = function() {}, TYPE = constants.TYPE, NAME = constants.NAME, WHITESPACE = TYPE.WhiteSpace, COMMENT = TYPE.Comment, IDENT = TYPE.Ident, FUNCTION = TYPE.Function, URL = TYPE.Url, HASH = TYPE.Hash, PERCENTAGE = TYPE.Percentage, NUMBER = TYPE.Number;
      ...
      module.exports = function(config) {
        ...
        return function(source, options) {
          var ast, context = (options = options || {}).context || "default", onComment = options.onComment;
          ...
          return "function" == typeof onComment && parser.scanner.forEachToken(((type, start, end) => {
            if (type === COMMENT) {
              const loc = parser.getLocation(start, end), value = cmpStr(source, end - 2, end, "*/") ? source.slice(start + 2, end - 2) : source.slice(start + 2, end);
              onComment(value, loc);
            }
          })), ast = parser.context[context].call(parser, options), parser.scanner.eof || parser.error(), 
          ast;
        };
      };
    },
    ...
    4736: (module, __unused_webpack_exports, __webpack_require__) => {
      module.exports = {
    ...
    8021: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    279: module => {
      const hasOwnProperty = Object.prototype.hasOwnProperty, shape = {
        generic: !0,
        ...
        scope: function deepAssign(dest, src) {
          for (const key in src) hasOwnProperty.call(src, key) && (isObject(dest[key]) ? deepAssign(dest[key], copy(src[key])) : dest[key] = copy(src[key]));
          return dest;
        },
        atrule: [ "parse" ],
        pseudo: [ "parse" ],
      ...
      function appendOrAssign(a, b) {
        ...
        for (let key in b) hasOwnProperty.call(b, key) && (result[key] = append(hasOwnProperty.call(a, key) ? a[key] : void 0, b[key]));
        return result;
      }
      ...
      function mix(dest, src, shape) {
        for (const key in shape) if (!1 !== hasOwnProperty.call(shape, key)) if (!0 === shape[key]) key in src && hasOwnProperty.call(src, key) && (dest[key] = copy(src[key])); else if (shape[key]) if ("function" == typeof shape[key]) {
          const fn = shape[key];
          ...
          for (const [name, value] of Object.entries(dest[key] || {})) res[name] = {}, value && mix(res[name], value, innerShape);
          for (const name in src[key]) hasOwnProperty.call(src[key], name) && (res[name] || (res[name] = {}), 
    ...
    9389: (module, __unused_webpack_exports, __webpack_require__) => {
      module.exports = {
        node: __webpack_require__(2723)
      };
    },
    ...
    8082: (module, __unused_webpack_exports, __webpack_require__) => {
      var TYPE = __webpack_require__(7093).TYPE, rawMode = __webpack_require__(5389).mode, COMMA = TYPE.Comma, WHITESPACE = TYPE.WhiteSpace;
      module.exports = function() {
        var children = this.createList();
        if (this.scanner.skipSC(), children.push(this.Identifier()), this.scanner.skipSC(), 
        this.scanner.tokenType === COMMA) {
          children.push(this.Operator());
          const startIndex = this.scanner.tokenIndex, value = this.parseCustomProperty ? this.Value(null) : this.Raw(this.scanner.tokenIndex, rawMode.exclamationMarkOrSemicolon, !1);
          if ("Value" === value.type && value.children.isEmpty()) for (let offset = startIndex - this.scanner.tokenIndex; offset <= 0; offset++) if (this.scanner.lookupType(offset) === WHITESPACE) {
    ...
    2916: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      module.exports.version = __webpack_require__(7151).version;
    },
    ...
    4690: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    9918: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    4258: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    6897: (module, __unused_webpack_exports, __webpack_require__) => {
      var isCustomProperty = __webpack_require__(5993).isCustomProperty, TYPE = __webpack_require__(7093).TYPE, rawMode = __webpack_require__(5389).mode, IDENT = TYPE.Ident, HASH = TYPE.Hash, COLON = TYPE.Colon, SEMICOLON = TYPE.Semicolon, DELIM = TYPE.Delim, WHITESPACE = TYPE.WhiteSpace;
      ...
      module.exports = {
        ...
        parse: function() {
          ...
          this.scanner.skipSC(), this.eat(COLON);
          const valueStart = this.scanner.tokenIndex;
          if (customProperty || this.scanner.skipSC(), value = parseValue ? this.parseWithFallback(consumeValue, consumeRaw) : consumeRaw.call(this, this.scanner.tokenIndex), 
          customProperty && "Value" === value.type && value.children.isEmpty()) for (let offset = valueStart - this.scanner.tokenIndex; offset <= 0; offset++) if (this.scanner.lookupType(offset) === WHITESPACE) {
            value.children.appendData({
              type: "WhiteSpace",
              loc: null,
              value: " "
          ...
          return this.scanner.isDelim(33) && (important = getImportant.call(this), this.scanner.skipSC()), 
    ...
    3745: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    4588: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    4406: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    9686: (module, __unused_webpack_exports, __webpack_require__) => {
      var IDENT = __webpack_require__(7093).TYPE.Ident;
      module.exports = {
        name: "Identifier",
        structure: {
    ...
    7363: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    2985: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    5389: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    3416: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    5310: (module, __unused_webpack_exports, __webpack_require__) => {
      var COMMA = __webpack_require__(7093).TYPE.Comma;
      module.exports = {
        name: "SelectorList",
        structure: {
    ...
    9334: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    3221: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    6512: (module, __unused_webpack_exports, __webpack_require__) => {
      module.exports = __webpack_require__(6991);
    },
    ...
    3388: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    2131: module => {
      ...
      module.exports = function(config) {
        ...
        var fastTraversalIteratorsNatural = createFastTraveralMap(iteratorsNatural), fastTraversalIteratorsReverse = createFastTraveralMap(iteratorsReverse), walk = function(root, options) {
          ...
          var walkReducer = (ret, data, item, list) => ret || walkNode(data, item, list), enter = noop, leave = noop, iterators = iteratorsNatural, context = {
            break: breakWalk,
            skip: skipNode,
            root,
            stylesheet: null,
    ...
    4433: (__unused_webpack_module, exports, __webpack_require__) => {
      var base64VLQ = __webpack_require__(6400), util = __webpack_require__(2728), ArraySet = __webpack_require__(7146).I, MappingList = __webpack_require__(1188).H;
