(() => {
  var __webpack_modules__ = {
    3349: (module, __unused_webpack_exports, __webpack_require__) => {
      var resolveKeyword = __webpack_require__(904).keyword, {hasNoChildren} = __webpack_require__(2222);
    ...
    788: (module, __unused_webpack_exports, __webpack_require__) => {
      var property = __webpack_require__(904).property;
      module.exports = function(node, item, list) {
        node.value.children && node.value.children.isEmpty() ? list.remove(item) : property(node.property).custom && /\S/.test(node.value.value) && (node.value.value = node.value.value.trim());
      };
    },
    7009: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    6269: (module, __unused_webpack_exports, __webpack_require__) => {
      var hasOwnProperty = Object.prototype.hasOwnProperty, walk = __webpack_require__(904).walk, {hasNoChildren} = __webpack_require__(2222);
    ...
    8948: (module, __unused_webpack_exports, __webpack_require__) => {
      var packNumber = __webpack_require__(7739).pack, MATH_FUNCTIONS = {
        calc: !0,
        min: !0,
        max: !0,
        clamp: !0
      ...
      module.exports = function(node, item) {
        ...
        if (node.value = value, "0" === value && null !== this.declaration && null === this.atrulePrelude) {
          ...
          if (this.function && MATH_FUNCTIONS.hasOwnProperty(this.function.name)) return;
          item.data = {
            type: "Number",
            loc: node.loc,
            value
    ...
    4018: (module, __unused_webpack_exports, __webpack_require__) => {
      var lexer = __webpack_require__(904).lexer, packNumber = __webpack_require__(7739).pack, blacklist = new Set([ "width", "min-width", "max-width", "height", "min-height", "max-height", "flex", "-ms-flex" ]);
      module.exports = function(node, item) {
    ...
    5677: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    5475: (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    912: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      function processRule(node, item, list) {
        ...
        list.prevUntil(item.prev, (function(prev, prevItem) {
          var prevBlock = prev.block, prevType = prev.type;
          if ("Rule" !== prevType) {
            var unsafe = utils.unsafeToSkipNode.call(selectors, prev);
            return !unsafe && "Atrule" === prevType && prevBlock && walk(prevBlock, {
              visit: "Rule",
              enter: function(node) {
          ...
          if (diff.eq.length) {
            ...
            if (!avoidRulesMerge) if (diff.ne1.length && !diff.ne2.length) {
              ...
              if ((blockLength = calcDeclarationsLength(diff.eq)) >= newBlockLength) {
    ...
    2478: (module, __unused_webpack_exports, __webpack_require__) => {
      var prepare = __webpack_require__(4949), mergeAtrule = __webpack_require__(8739), initialMergeRuleset = __webpack_require__(5475), disjoinRuleset = __webpack_require__(1457), restructShorthand = __webpack_require__(6688), restructBlock = __webpack_require__(6129), mergeRuleset = __webpack_require__(6610), restructRuleset = __webpack_require__(912);
      module.exports = function(ast, options) {
